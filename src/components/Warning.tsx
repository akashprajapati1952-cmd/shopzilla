export default function Warning({onclick}:{onclick: ()=>void}){
    return (
        <div className="flex max-h-[75%]  overflow-auto border rounded-xl flex-col gap-2 p-5 fixed items-center bg-green-400 z-20 w-[80dvw] max-w-md  top-20 left-[10dvw] md:left-[calc((100dvw-448px)/2)]">
